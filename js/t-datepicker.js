...
;(function($){
    ...
    $.fn.tDatePicker = function( pr_el, options ) {
        ...
        function setThemeCheckDate(pr_title, pr_class, pr_data_utc, pr_input, pr_fm_input) {
            ...
            '</div>'+
            '<input type="text" id="dateInput" placeholder="Add dates" class="t-input-'+pr_class+'"'+' value="'+pr_fm_input+'" name="'+pr_input+'">'
            //'<input type="text" placeholder="Add dates" class="t-input-'+pr_class+'"'+' value="' + (pr_fm_input ? pr_fm_input : 'add dates') + '" name="'+pr_input+'">'

            //'<input type="text" '(pr_fm_input ? pr_fm_input : 'add dates')' class="t-input-'+pr_class+'" name="'+pr_input+'">'

            
            // value="' + (pr_fm_input ? pr_fm_input : 'add dates')

            // (pr_fm_input ?             
            //     '<input type="text" placeholder="Add dates" class="t-input-'+pr_class+'"'+' value="'+pr_fm_input+'"  name="'+pr_input+'">' : '<input type="text" placeholder="Add dates" class="t-input-'+pr_class+'"'+' value="Add dates" name="'+pr_input+'">')
        ...
        function showThemeDate(pr_class, pr_data_utc) {
            if ( pr_data_utc !== 0 && pr_data_utc !== null ) {
                ...
                if ( settings.showDateTheme === 'dd' ) {
                    return '' + check_num_10(d.getDate()) +''
                } else if ( settings.showDateTheme === 'dd/mm' || settings.showDateTheme === 'dd-mm' ) {
                    return '' + check_num_10(d.getDate()) +' '+ showMonths.toLocaleString('default', { month: 'short' }) +''
                } else {
                    return '' + check_num_10(d.getDate()) +' '+ showMonths.toLocaleString('default', { month: 'short' }) +' '+check_num_10(d.getFullYear()) +''
                }
            } else {
                return '';
            }
